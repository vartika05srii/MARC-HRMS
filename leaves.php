	...
	<div class="container-fluid"> 	
			<div class="row">
				<div class="col-lg-12" style="background-image: linear-gradient(to right top, #a6abb3, #7e898e, #5c6968, #404943, #282a22);min-height: 80px; ">
					<h3 class="float-left" style="padding-top: 15px; font-size: 38px; font-family:bodoni mt; margin-left: 90px;color:#fff;"> <i class="fas fa-envelope id="icon" style="color:#c11935 "></i> Leaves</h3>
...
<div class="row">
	...
	<tr>
		...
		<td><?php $empid=$row['empid'];?>
			<?php
			$qname="select name from tbl_employee where empid='$empid'";
			$res_qname=mysql_query($qname);
		...
		<td><a href="status.php?lid=<?php echo $row['leaveid'];?>"><?php echo $row['status']; ?></a></td>
	</tr>
	<?php
	$a++;
	}
