...
<html>
<head>
	<title>MARC | Add Attendance</title>
	...
	<div class="container-fluid"	> 	
			<div class="row">
				<div class="col-lg-12" style="background-image: linear-gradient(to right top, #a6abb3, #7e898e, #5c6968, #404943, #282a22);min-height: 80px; ">
					<h3 class="float-left" style="padding-top: 15px; font-size: 38px; font-family:bodoni mt; margin-left: 90px;color:#fff;"> <i class="fas fa-book-open id="icon" style="color:#c11935 "></i> Add Attendance </h3>
	...
	<tbody>
			...
			<tr>
				...
				<td>
					...
					{
						?>
					<a href="chg_a_p.php?attd_id=<?php echo $row1['attd_id']; ?>" style="text-decoration: none;color:blue;">present</a>
					<?php
					}
					else
					{
						?>
					<a href="chg_p_a.php?attd_id=<?php echo $row1['attd_id']; ?>" style="text-decoration: none;color:red;">absent</a>
					<?php
					}
					?>
